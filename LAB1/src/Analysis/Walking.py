...
df = pd.read_csv('/home/iso1/Desktop/EECE5554/LAB1/src/Analysis/Walking.csv')
...
plt.xlabel('Easting')
plt.ylabel('Northing')
plt.title('Scatterplot of Walking Northing vs Easting Data')
plt.show()
...
plt.xlabel('Time')
plt.ylabel('Altitude')
plt.title('Scatterplot of Walking Altitude vs Time Data')
plt.show()
...
plt.title('Error of  Walking data.Frequency vs Error data')
plt.show()
