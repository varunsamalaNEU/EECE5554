...
df = pd.read_csv('/home/iso1/Desktop/EECE5554/LAB1/src/Analysis/Closed.csv')
...
plt.xlabel('Easting')
plt.ylabel('Northing')
plt.title('Scatterplot Closed-area vs Easting Data')
plt.show()
...
plt.xlabel('Time')
plt.ylabel('Altitude')
plt.title('Scatterplot Closed-area  Altitude vs Time Data')
plt.show()
...
plt.title('Error of Closed-area Frequency vs Error data')
plt.show()
